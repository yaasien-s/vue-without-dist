    ...
    <section id="project-card">
        <div class="project-card">
            <div v-if="getProject" class="project-details">
                ...
                <a :href="getProject.github" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    </svg> Github</a> <a :href="getProject.link" target="_blank"><svg width="24" height="24"

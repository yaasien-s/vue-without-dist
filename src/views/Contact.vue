<template>
    <section id="contact">
        <div class="contact">
            <h1 class="display-4 contact-heading">Contact</h1>
                    ...
                    <div class="contact-text col-sm-6">
                        ...
                        <ul class="contact-info">
                            <li>
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-geo-alt-fill mx-3" viewBox="0 0 16 16">
                                        <path
                                            d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                                    </svg>
                                    <strong>Address:</strong>
                                    <p id="contact-address">Cape Town, Western Cape, South Africa</p>
                                </div>
                            </li>
                            <li>
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-telephone mx-3" viewBox="0 0 16 16">
                                        <path
                                    ...
                                    <strong>Phone:</strong>
                                    <ul>
                                        <li><a href="tel:0615053706" class="ltr-dir">061 505 3706</a></li>
                                    </ul>
                                </div>
                            </li>
                            <br>
                            <li>
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-envelope mx-3" viewBox="0 0 16 16">
                                        <path
                                            d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
                                    </svg>
                                    <strong>Email:</strong>
                                    <ul>
                                        <li><a href="mailto:info@nafie.com">yaasiensalaam.com</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
<div id="contact-socials">
      <a href="https://www.linkedin.com/in/yaasien-s-4587aa133/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
      ...
      <a href="https://github.com/yaasien-s" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24"
      ...
      <a href="https://codepen.io/yaasien-s" target="_blank"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
      ...
      <a href="https://app.netlify.com/teams/yaasien-s/overview" target="_blank">
        <svg width="24" height="24" viewBox="0 0 256 256" fill="currentColor" version="1.1"
          ...
          <form
            id="contact-form"
            action="https://formspree.io/f/xpzbprkz"
            method="POST"
            target="_blank"
          >
            <label>Name</label>
            <input type="text" class="w-100 mx-0" placeholder="John Doe" required />
            <label>E-mail</label>
            <input type="email" class="w-100 mx-0" placeholder="johndoe@gmail.com" name="_replyto" required />
            <label>Message</label>
            <textarea name="textarea" placeholder="Hi there..." required class="w-100 h-25"></textarea>
...
<style>
    ...
    input {
        ...
        border-bottom: 1px solid #568259 !important;
        color: #568259;
        border-radius: 10px;
        background: #568259;
        box-shadow: 0 0 10px rgba(0, 0, 0, 25);
